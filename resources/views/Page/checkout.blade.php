								...
								<div>
									...
									<div class="media">
										...
										<div class="media-body">
											<p class="font-large">{{$product['item']['name']}}
											</p>
						...
						<div class="your-order-body">
							<ul class="payment_methods methods">
								<li class="payment_method_bacs">
									...
									<div class="payment_box payment_method_bacs" style="display: block;"> Make your payment directly into our bank account. Please use your Order ID as the payment reference.
								...
								<li class="payment_method_vnpay">
									...
									<div class="payment_box payment_method_vnpay" style="display: none;">Pay via VnPay; you can pay with your credit card if you don’t have a VnPay account
									</div>
								</li>
							</ul>
						</div>
